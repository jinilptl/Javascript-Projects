...
submit_Btn.addEventListener('click',(e)=>{
    ...
    let [gujarati,science,social,maths,sanskrit,english]=document.querySelectorAll('#gujarati,#science,#social,#maths,#sanskrit,#english');
    ...
    let TotalMarks=Gujarati_value+Science_value+Social_value+Maths_value+Sanskrit_value+English_value
...
const resultHTML = `
  <div class="result-box">
    ...
    <p class="status pass">${PassOrFail?('🎉 Congratulations! You have Passed.'):"❌ Sorry, you have failed. Please work harder and try again. Your efforts matter!"}</p>
  </div>
`;
